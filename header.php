...
<header class="main-footer show-mobile" amp-fx='float-in-top'>
    <div class="footer-container">
        ...
        <div class="footer-search footer-icon" style="flex: 0.3;margin-right: 20px;">
            <a class="footer-search footer-icon" on="tap:twimcast-sidebar.open" role="button" tabindex="1" aria-label="search">
            ...
            <a class="footer-profile footer-icon" on="tap:twimcast-sidebar.open" role="button" tabindex="1" aria-label="sidebar-open">
