...
<body>
	<footer class="main-footer show-mobile">
		<div class="footer-container">
			...
			<a href="#" class="footer-search footer-icon">
			...
			<a href="#" class="footer-explore footer-icon">
			...
			<a href="#" class="footer-profile footer-icon">
